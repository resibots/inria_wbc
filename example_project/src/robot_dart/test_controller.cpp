...
int main(int argc, char* argv[])
{
    try {
        ...
        ("behavior,b", po::value<std::string>()->default_value("../etc/testttt_behavior.yaml"), "Configuration file of the tasks (yaml) [default: ../etc/example_project_behavior.yaml]")
        ...
        ("controller,c", po::value<std::string>()->default_value("../etc/testttt_controller.yaml"), "Configuration file of the tasks (yaml) [default: ../etc/example_project_controller.yaml]")
