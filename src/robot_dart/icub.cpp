...
int main(int argc, char* argv[])
{
    try {
        ...
        ("controller,c", po::value<std::string>()->default_value("../etc/icub/humanoid_pos_tracker.yaml"), "Configuration file of the tasks (yaml) [default: ../etc/icub/pos_tracker.yaml]")
