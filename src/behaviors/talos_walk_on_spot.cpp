...
namespace inria_wbc
{
    namespace behaviors
    {
            ...
            Behavior(std::make_shared<inria_wbc::controllers::TalosPosTracking>(params))
        {
            ...
            trajectories_.push_back(trajectory_handler::compute_traj(com_right, com_right, params.dt, 2*trajectory_duration_));
            trajectories_.push_back(trajectory_handler::compute_traj(com_right, com_left, params.dt, trajectory_duration_));
            trajectories_.push_back(trajectory_handler::compute_traj(com_left, com_left, params.dt, 2*trajectory_duration_));
